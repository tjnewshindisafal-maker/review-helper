...
- Output ONLY the review text. No quotes. No label. No explanation.`;
    ...
    const models = ['meta-llama/llama-4-scout-17b-16e-instruct', 'meta-llama/llama-4-maverick-17b-128e-instruct', 'openai/gpt-oss-20b'];
    let reviewText = null;
    let lastErr = null;
...
app.get('/qr-all', (req, res) => res.sendFile(path.join(__dirname, 'public', 'qr-all.html')));

app.get('/qr-card', (req, res) => res.sendFile(path.join(__dirname, 'public', 'qr-card.html')));
